...
AUTHENTICATION_BACKENDS = ["apps.core.auth.EmailOrUsernameBackend"]
LOGIN_URL = "login"
...
PUBLISHER_GITHUB_TOKEN = os.getenv("PUBLISHER_GITHUB_TOKEN", "")
PUBLISHER_GITHUB_REPOSITORY = os.getenv("PUBLISHER_GITHUB_REPOSITORY", "hsdarestani/publisher")
PUBLISHER_GITHUB_REF = os.getenv("PUBLISHER_GITHUB_REF", "main")
